...
| `spacedock gate record <entity> --briefing FILE` | Bind a complete Briefing. The recorder derives the current-stage logical gate and whether this opens, rebinds, or supersedes an attempt. |

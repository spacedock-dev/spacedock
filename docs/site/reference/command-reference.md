...
| `spacedock gate record <entity> --room PATH` | Verify a prepared gate room and record its direct binding Result. The recorder derives fixed provider paths and the complete Artifact/Reference association; advisory output remains retained evidence. |

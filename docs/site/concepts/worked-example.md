...
test plan — each AC naming a check outside the entity body that can fail.
...
exercised five mandated probes — each reddening the test suite, then reverting —
and refuted nothing material. Channel-tracking was confirmed clean. That clean

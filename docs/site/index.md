...
You are the captain. You set the bar and make the calls; the agents do the rest. See [the operating model](concepts/operating-model.md) for the three roles and how they divide the work.

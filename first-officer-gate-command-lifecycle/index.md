...
| `docs/site/concepts/gates-and-decisions.md` | +9 / -2 |
| `docs/specs/scenario-testing-principles.md` | +2 / -1 |

The intended amendment is **+77/-16**, yielding at most 1,549 branch additions—39 below the approved 1,588 cap. Additions have a hard stop at **+95**, yielding at most 1,567 branch additions and preserving exactly 21 lines of cap headroom. No eighth file is permitted without re-ideation.

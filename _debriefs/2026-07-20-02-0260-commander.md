...
Commander session record. Durable state of authority: each entity's frontmatter and stage reports, the merged PRs, and `_evidence/0260-lure-scenarios/`. This file captures what lived only in conversation.

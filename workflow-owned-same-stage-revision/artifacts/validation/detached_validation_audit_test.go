...
func TestDetachedSameStageRetainedState(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"before", 1, 0}, {"after", 2, 0}, {"initial-controls-review-required", 1, 0}, {"initial-controls-separate-review-required", 1, 0}, {"initial-controls-cycle-limit", 3, 0}, {"identity-fixed-round-missing", 1, 0}, {"round-final", 2, 1},
	} {

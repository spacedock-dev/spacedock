...
Estimate net LOC change: -500, across ~48 files. Insertions ≈ +120, deletions ≈ +620. Breakout: product (Go binary + claudeteam + skills prose) net ≈ -180 (ins +50 / del +230); tests + fixtures net ≈ -320 (ins +70 / del +390 — test-side additions already budgeted at ~2x first instinct per today's calibration); docs net ≈ ±0 (registry line + help-text diff counted in product). Tolerance: net within [-250, -750]; files ≤ 60. Declared in net — this task's purpose is removal; gross would count the deletions as growth.

...
func TestSharedLiveTODOEvidenceSet(t *testing.T) {
	want := map[liveEvidenceKey]string{{target: liveEvidenceTargetCodex, journey: "full-ensign-cycle"}: codexEnsignContractDefectID, {target: liveEvidenceTargetPi, journey: "gate-guardrail"}: gateGuardrailDefectID, {target: liveEvidenceTargetClaudeSonnet, journey: "default-headless-gate-stop"}: defaultHeadlessGateStopDefectID, {target: liveEvidenceTargetPi, journey: "default-headless-gate-stop"}: defaultHeadlessGateStopDefectID, {target: liveEvidenceTargetClaudeSonnet, journey: "smallest-sufficient-mechanism"}: liveDurableJourneyDefectID, {target: liveEvidenceTargetCodex, journey: "smallest-sufficient-mechanism"}: liveDurableJourneyDefectID, {target: liveEvidenceTargetPi, journey: "smallest-sufficient-mechanism"}: liveDurableJourneyDefectID, {target: liveEvidenceTargetClaudeSonnet, journey: "keep-moving-posture"}: liveDurableJourneyDefectID, {target: liveEvidenceTargetCodex, journey: "keep-moving-posture"}: liveDurableJourneyDefectID, {target: liveEvidenceTargetPi, journey: "keep-moving-posture"}: liveDurableJourneyDefectID, {target: liveEvidenceTargetClaudeSonnet, journey: "rejection-flow"}: liveRejectionFlowDefectID, {target: liveEvidenceTargetPi, journey: "rejection-flow"}: liveRejectionFlowDefectID, {target: liveEvidenceTargetCodex, journey: "withdrawn-gate-recovery"}: liveWithdrawnGateDefectID, {target: liveEvidenceTargetCodex, journey: "rejection-flow"}: liveRejectionFlowDefectID}
	for _, target := range []liveEvidenceTarget{liveEvidenceTargetClaudeSonnet, liveEvidenceTargetClaudeOpus, liveEvidenceTargetCodex, liveEvidenceTargetPi} {

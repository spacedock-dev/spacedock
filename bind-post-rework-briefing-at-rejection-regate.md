...
The Opus execution of the shared rejection-flow journey is temporarily TODO under this task. Keep Sonnet, Codex, Pi, recorded-gate, keep-moving, and deterministic round/gate coverage active. Re-enable the Opus case when this task lands.
...
Verified by: repeated clean Opus rejection-flow journeys record validation/1 as advisory, create a distinct post-rework canonical Briefing, and bind only that new Briefing to the ordinary final gate.
...
**AC-4 - The quarantined Opus live journey is restored.**
Verified by: remove the linked TODO, run the focused Opus rejection-flow repeatedly, then run the complete Opus shared suite at the exact candidate tip.

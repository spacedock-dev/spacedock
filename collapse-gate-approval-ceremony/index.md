...
Two CI failures surfaced on the PR branch after validation PASSED, both fixed as ordinary test-corpus maintenance (no production code changed, no AC re-opened):

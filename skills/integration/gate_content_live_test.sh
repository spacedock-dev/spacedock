...
- **Gate content:** Show only the median orbit drift and that approval releases the observation.
...
if grep -Eqi 'raw frames|anomaly catalog|SKIPPED|FAILED|None|N/A|0 skipped|0 failed' "$fixture/final.txt"; then
